...
struct Appearance { bool clouds=true, atmosphere=true, trails=true, closeup=false, autoSpin=false; };
...
void setAppearance(bool clouds,bool atmosphere,bool trails,bool closeup,bool autoSpin);
