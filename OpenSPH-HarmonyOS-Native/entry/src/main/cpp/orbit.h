...
struct OrbitContact { uint32_t count=0;int a=-1,b=-1;double time=0,speed=0; bool hasIncoming=false;std::array<OrbitBody,2> incoming{};std::vector<OrbitBody> world; };
