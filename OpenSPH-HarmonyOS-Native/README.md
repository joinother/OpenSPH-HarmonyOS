...
> 类型：当前项目概览；源码版本：0.43.0；更新日期：2026-09-08（Asia/Shanghai）。
...
- 新增“两条潮汐尾／反转一片星系”：可调质量比、偏移、盘倾角、接近速度与旋转方向；恒星群按扩展势引力积分，支持中心跟随、诊断、命名实验和 v12 回放。见 [星系潮汐](docs/reference/GALACTIC-TIDES.md)。这是限制性形态模型，尚无气体、自洽暗晕或完整合并。
...
- 主题实验库提供十八个主题（复用九张原创概念封面与一张 NASA 月面地图封面）：慢撞、快撞、错位相撞、旋转岩石、蔚蓝世界、三种行星探索、“环影之间”、“环为什么会错位”和“给环一点额外速度”和“月海与高地”，以及“碰撞放大镜”的速览／细看两组和直接／预松弛碰撞两组，以及静止岩球自由演化两组；包含观察目标、速度／粒子预算对照、曲线入口和恢复初始条件。
