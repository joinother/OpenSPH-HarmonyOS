...
> 类型：当前项目概览；源码版本：0.24.0；更新日期：2026-09-07（Asia/Shanghai）。
...
- 主题实验库提供十个主题（九张原创概念封面与一张 NASA 月面地图封面）：慢撞、快撞、错位相撞、旋转岩石、蔚蓝世界、三种行星探索、“环影之间”、“环为什么会错位”和“给环一点额外速度”和“月海与高地”；包含观察目标、速度对照和恢复初始条件。
