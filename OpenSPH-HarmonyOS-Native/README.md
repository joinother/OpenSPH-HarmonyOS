...
> 类型：当前项目概览；源码版本：0.18.0；更新日期：2026-09-06（Asia/Shanghai）。
...
- 主题实验库提供七张原创概念封面卡片：慢撞、快撞、错位相撞、旋转岩石、蔚蓝世界、三种行星探索与“环影之间”；包含观察目标、速度对照和恢复初始条件。
