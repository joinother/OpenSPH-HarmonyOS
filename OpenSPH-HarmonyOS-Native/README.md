...
> 类型：当前项目概览；源码版本：0.23.0；更新日期：2026-09-07（Asia/Shanghai）。
...
[SpaceEngine 调研](docs/research/SPACEENGINE-2026-09-06.md) 已补充 2026-09-07 手册与创意工坊选读：12 项改进和 6 个原创体验提案，已有外观与局部环配方保存基础；镜头状态、曝光与海洋／云影控件已接入，后续规划真实地图、资源加载和三维银河。其余提案不计入当前能力。

[Celestia 源码与插件调研](docs/research/CELESTIA-SOURCE-ADDONS-2026-09-07.md) 对本地源码建立 803 个文件清单，选读 26 份源码／工程文档／许可文件，并核对官方插件与移动版资料。0.22.0 已补镜头完成／取消状态及编辑不强制近看，0.23.0 已补曝光和海洋／云影控制；后续继续独立选择／跟随语义、真实地理材质及按需加载；形成 12 项改进与 8 个体验提案。论坛受访问验证限制，未读取帖子；本轮未引入 Celestia 代码或素材。
