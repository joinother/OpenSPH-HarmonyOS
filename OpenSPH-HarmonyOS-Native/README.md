...
> 类型：当前项目概览；源码版本：0.36.0；更新日期：2026-09-08（Asia/Shanghai）。
...
- 主题实验库提供十四个主题（复用九张原创概念封面与一张 NASA 月面地图封面）：慢撞、快撞、错位相撞、旋转岩石、蔚蓝世界、三种行星探索、“环影之间”、“环为什么会错位”和“给环一点额外速度”和“月海与高地”，以及“碰撞放大镜”的速览／细看两组和直接／预松弛碰撞两组；包含观察目标、速度／粒子预算对照、曲线入口和恢复初始条件。
...
0.36.0 接入岩体分别预松弛、准备取消、碰撞组装与同参数对照实验，保存完整准备配置。见 [本轮记录](docs/releases/RELEASE-0.36.0.md)。
