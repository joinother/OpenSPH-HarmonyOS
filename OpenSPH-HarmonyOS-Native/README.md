...
> 类型：当前项目概览；源码版本：0.19.0；更新日期：2026-09-06（Asia/Shanghai）。
...
- 主题实验库提供八张原创概念封面卡片：慢撞、快撞、错位相撞、旋转岩石、蔚蓝世界、三种行星探索、“环影之间”和“环为什么会错位”；包含观察目标、速度对照和恢复初始条件。
- 开普勒示踪环：192 个无质量点、12 条解析圆轨道、独立 0–24 小时时间轴；展示内外圈差速，可查询位置和速度。
