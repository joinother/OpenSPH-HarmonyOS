...
> 类型：当前项目概览；源码版本：0.28.0；更新日期：2026-09-07（Asia/Shanghai）。
...
0.28.0 是开发检查点：核心数值、回放与 81 项主机测试已通过；最终横屏复验、完整旧 UI／CLI 回归和现场恢复因模拟器交错操作待继续，见 [验收状态](docs/evidence/sph-0.28.0-acceptance-status.json)。
