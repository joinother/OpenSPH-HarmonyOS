...
try{
 ...
 h('shell','snapshot_display','-f','/data/local/tmp/sph-impact-local.jpeg');h('file','recv','/data/local/tmp/sph-impact-local.jpeg','docs/evidence/impact-sph-0.54.0/local-sph.jpeg');
