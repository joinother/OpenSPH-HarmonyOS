...
try{
  action('preset.5','paused');let catalog=call('getUiState');assert.ok(catalog.actions.length>45);assert.equal(catalog.fields.length,29);assert.ok(catalog.fields.some(f=>f.field==='material.exposure'));
