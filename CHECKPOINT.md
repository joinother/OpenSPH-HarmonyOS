...
2026-09-09 文案修订：按用户反馈把 23 个标题和卡片介绍改成直接陈述场景的短句，例如“撞击受损岩石”“两个星系相遇”；同步撞击和旋转按钮。开发构建已安装到指定模拟器，108 项检查通过，配置不变且原场景与文件恢复，见 [文案验证](OpenSPH-HarmonyOS-Native/docs/evidence/naming-2026-09-09/verification.json)。下述已发布 0.57.0 产物仍是上一轮快照，本次不覆盖它们。
