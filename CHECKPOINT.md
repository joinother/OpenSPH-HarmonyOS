...
记录日期：2026-09-07（Asia/Shanghai）；源码版本：0.30.0。
...
- 0.30.0 新增“碰撞放大镜”速览／细看主题、曲线入口、30 项材料方程检查及固定时间步／分辨率研究。89 项主机测试、原生求解与连续切换回归、真实两组主题与三种窗口按钮验收通过；恢复原实验与十个用户存档。首次主题切换超时的原因仍未确定，保留调查记录，最终包重建后复测通过。见 [0.30.0 记录](OpenSPH-HarmonyOS-Native/docs/releases/RELEASE-0.30.0.md)。
