...
本分支保存星体实验室 0.23.0 的 ArkTS/ArkUI 原生检查点，继续开发请进入 [OpenSPH-HarmonyOS-Native](OpenSPH-HarmonyOS-Native)，恢复步骤和本轮验证见 [检查点说明](CHECKPOINT.md)。以下正文保留旧 wxWidgets 桌面移植路线；两个工程分别维护。
